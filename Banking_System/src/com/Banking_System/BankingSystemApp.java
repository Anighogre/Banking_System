...
public class BankingSystemApp {
    public static void main(String[] args) {
    	//Creates an instance of BankingServiceImpl (the implementation class of BankingService) to handle all banking-related operations.
        BankingService service = (BankingService) new BankingServiceImpl();
        Scanner scanner = new Scanner(System.in);

        while (true) { //Starts an infinite loop that repeatedly displays the menu and processes user input until the user chooses to exit.
            ...
            //A switch statement handles the user's choice by executing the corresponding block of code for the selected menu option.
            switch (choice) {
                case 1:
                    // Add Customer
                    ...
                    //Creates a Customer object with the entered details.
                    Customer customer = new Customer(customerId, name, address, contact);
                    service.addCustomer(customer);//Calls the addCustomer method of service to add the customer to the database.
                ...
                case 5:
                    ...
                    //Calls getTransactionsByAccountId to retrieve transactions for that account.
                    ...
                    for (Transaction t : transactions) { //Iterates through and prints each Transaction object.
                ...
                case 7:
                    // Find Customer by ID
                    System.out.print("Enter Customer ID: ");
                    int findCustomerId = scanner.nextInt(); //Fetches a customer by ID using findCustomerById.
                ...
                case 9:
                    // List All Customers
                    List<Customer> customers = service.getAllCustomers(); //Calls getAllCustomers to retrieve all customers.
                    System.out.println("All Customers:");
                    for (Customer c : customers) { //Iterates through and prints each Customer object.
